...
public class TestList {
  ...
  public void testContains() {
    // (complete) TODO write assertions using
    // list.contains(77)
  ...
  public void testRemoveObject() {
    ...
    assertEquals(77, list.get(3).intValue());
    list.remove(Integer.valueOf(5)); // (complete) what does this one do?
    // list: {3, 77, 4, 77, 6}
  ...
  public void testContainsAll() {
    ...
    list.add(77);
    list.add(66);
    // (complete) TODO using containsAll and List.of (see above),
  ...
  public void testAddAll() {
    // (complete) TODO in a single statement using addAll and List.of,
  ...
  public void testRemoveAll() {
    ...
    list.add(77);
    list.add(66);
    // (complete) TODO in a single statement using removeAll and List.of,
  ...
  public void testRetainAll() {
    ...
    list.add(77);
    list.add(66);
    // (complete) TODO in a single statement using retainAll and List.of,
    // remove items from the list to make the following assertions pass
    // (without touching the assertions themselves)
  ...
  public void testSet() {
    ...
    list.add(77);
    list.add(66);
    // (complete) TODO use the set method to change specific elements in the list
  ...
  public void testSubList() {
    ...
    list.add(77);
    list.add(66);
    // (complete) TODO fix the arguments in the subList method so that the assertion
    // passes
